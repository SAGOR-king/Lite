...
╚══════╝╚═╝  ╚═╝ ╚═════╝  ╚═════╝ ╚═╝  ╚═╝                                                  
  \033[91;1m  ╔════════════════════════════════════════╗
   {H} ║{P}[{H}•{P}] Author    :{warna} SAGOR-king               {N}{H}║
  {H}  ║{P}[{H}•{P}] Facebook  : {H}Md Sagor shekh          {N}{H}║
    {H}║{P}[{H}•{P}] Whatsapp  : {M}+8801792417848          {N}{H}║
  {H}  ║{P}[{H}•{P}] Github    : {K}github.com/SAGOR-king{N}    {H}  ║
  {H}  ║{P}[{H}•{P}] Status    : {H}VIP {P}     {N}      {H}     ║
...
def mainx():
    ...
    if mahin in ["1","01"]:
     ...
     os.system("xdg-open https://github.com/SAGOR-king");mainx()
    elif mahin in ["8","08"]:
     os.system("xdg-open https://www.facebook.com/FB.KING.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");mainx()
    elif mahin in ["0","00"]:
     print(f'{gen}{RED}Exited {H} SAGOR-king{P}Terminal ');os.system("xdg-open https://www.facebook.com/FB.KING.MAHIN.NAME.TOH.SONSO?mibextid=ZbWKwL");time.sleep(3);os.system('xdg-open https://www.facebook.com/groups/fb.king.cyber/?ref=share');exit()
    else:
